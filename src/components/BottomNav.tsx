...
const BottomNav = ({ activeTab, setActiveTab }: BottomNavProps) => (
  <div className="fixed bottom-0 left-1/2 -translate-x-1/2 bg-white border-t border-gray-100 flex items-center justify-around px-6 py-3 z-50" style={{ width: 384 }}>
